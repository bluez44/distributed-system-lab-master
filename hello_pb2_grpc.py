...
class GreeterStub(object):
    ...
    def __init__(self, channel):
        ...
        self.LotsOfReplies = channel.unary_stream(
                '/tutorial.Greeter/LotsOfReplies',
                request_serializer=hello__pb2.HelloRequest.SerializeToString,
                response_deserializer=hello__pb2.HelloReply.FromString,
                )
...
class Greeter(object):
    ...
    def SayHello(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tutorial.Greeter/SayHello',
    ...
    def LotsOfReplies(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_stream(request, target, '/tutorial.Greeter/LotsOfReplies',
            hello__pb2.HelloRequest.SerializeToString,
            hello__pb2.HelloReply.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
